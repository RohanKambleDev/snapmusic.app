        ...
        <div class="w-full max-w-2xl">
          <div class="flex items-center justify-center gap-4">
            ...
            <div class="flex items-center gap-3">
              <div id="stepDot1" class="h-9 w-9 rounded-full bg-yellow-500 text-black font-semibold flex items-center justify-center">1</div>
            ...
            <!-- Step 2 -->
            <div class="flex items-center gap-3">
              <div id="stepDot2" class="h-9 w-9 rounded-full bg-white/10 text-white/70 font-semibold flex items-center justify-center">2</div>
            ...
            <!-- Step 3 -->
            <div class="flex items-center gap-3">
              <div id="stepDot3" class="h-9 w-9 rounded-full bg-white/10 text-white/70 font-semibold flex items-center justify-center">3</div>
      ...
      <div class="mt-10 flex justify-center">
        <div class="w-full max-w-3xl">
          ...
          <section id="panel1" class="block">
            <div class="rounded-3xl border border-white/10 bg-white/[0.03] shadow-[0_20px_80px_rgba(0,0,0,0.55)] p-8">
              <div
                id="imageDrop"
              ...
              >
                ...
                <div id="imageEmpty" class="space-y-4">
                  <div class="mx-auto h-16 w-16 rounded-2xl bg-white/5 flex items-center justify-center">
                    <!-- Image icon (inline SVG) -->
                    <svg class="h-9 w-9 text-white/50" viewBox="0 0 24 24" fill="none" aria-hidden="true">
                      <path d="M4 7a3 3 0 0 1 3-3h10a3 3 0 0 1 3 3v10a3 3 0 0 1-3 3H7a3 3 0 0 1-3-3V7Z" stroke="currentColor" stroke-width="1.5"/>
                      <path d="M8 14l2.2-2.2a1 1 0 0 1 1.4 0L14 14.2a1 1 0 0 0 1.4 0L16 13.6a1 1 0 0 1 1.4 0L20 16" stroke="currentColor" stroke-width="1.5" stroke-linecap="round"/>
                      <path d="M15.5 9.2a1.2 1.2 0 1 1-2.4 0 1.2 1.2 0 0 1 2.4 0Z" fill="currentColor" opacity="0.7"/>
                    </svg>
                  </div>
                ...
                <div id="imagePreviewWrap" class="hidden">
                  <div class="flex flex-col items-center gap-4">
                    <div class="w-full max-w-lg overflow-hidden rounded-2xl border border-white/10 bg-black/30">
                      <img id="imagePreview" alt="Selected photo preview" class="w-full h-[240px] object-contain bg-black/40" />
                    </div>
                ...
                <!-- Drop highlight -->
                <div id="imageDropHint" class="pointer-events-none absolute inset-0 rounded-2xl ring-0 ring-emerald-400/30 transition"></div>
              </div>
            ...
            <div class="rounded-3xl border border-white/10 bg-white/[0.03] shadow-[0_20px_80px_rgba(0,0,0,0.55)] p-8">
              ...
              >
                ...
                <div id="audioEmpty" class="space-y-4">
                  <div class="mx-auto h-16 w-16 rounded-2xl bg-white/5 flex items-center justify-center">
                    ...
                    <svg class="h-9 w-9 text-white/50" viewBox="0 0 24 24" fill="none" aria-hidden="true">
                      ...
                      <path d="M9 18a3 3 0 1 1-6 0 3 3 0 0 1 6 0Z" fill="currentColor" opacity="0.7"/>
                      <path d="M19 16a3 3 0 1 1-6 0 3 3 0 0 1 6 0Z" fill="currentColor" opacity="0.7"/>
                    </svg>
                  </div>
                ...
                <div id="audioPreviewWrap" class="hidden">
                  <div class="flex flex-col items-center gap-4">
                    <div class="w-full max-w-lg rounded-2xl border border-white/10 bg-black/30 p-4">
                      <div class="text-sm text-white/70">
                        <span class="font-medium text-white/85">Selected:</span>
                ...
                <div id="audioDropHint" class="pointer-events-none absolute inset-0 rounded-2xl ring-0 ring-emerald-400/30 transition"></div>
              </div>
            ...
            <div class="rounded-3xl border border-white/10 bg-white/[0.03] shadow-[0_20px_80px_rgba(0,0,0,0.55)] p-8">
              <div class="grid gap-6 md:grid-cols-2">
                <div class="rounded-2xl border border-white/10 bg-black/20 overflow-hidden">
                  ...
                  <img id="finalImage" class="w-full h-56 object-contain bg-black/40" alt="Final selected photo" />
                </div>
                ...
                <div class="rounded-2xl border border-white/10 bg-black/20">
                  ...
                  <div class="p-4">
                    ...
                    <div class="mt-4 text-xs text-white/35">
                      Prototype note: “Create” is simulated here. In Laravel, submit the image+audio to your backend to render MP4.
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div class="mt-8 flex flex-col gap-4">
                <div id="createStatus" class="hidden rounded-2xl border border-white/10 bg-black/20 p-4">
                  <div class="flex items-center justify-between gap-4">
                    <div class="text-sm text-white/80">
                      <span class="font-semibold">Creating video…</span>
                      <span class="text-white/50" id="createHint">This is a demo progress.</span>
                    </div>
                ...
                <div id="createDone" class="hidden rounded-2xl border border-emerald-400/20 bg-emerald-500/10 p-4">
  ...
  <script>
    ...
    function setStep(step) {
      ...
      const active = (dot, label) => {
        dot.className = 'h-9 w-9 rounded-full bg-yellow-500 text-black font-semibold flex items-center justify-center';
        label.className = 'text-sm text-white/90';
      };
      const done = (dot, label) => {
        dot.className = 'h-9 w-9 rounded-full bg-emerald-400/90 text-black font-semibold flex items-center justify-center';
        label.className = 'text-sm text-white/90';
      };
      const idle = (dot, label) => {
        dot.className = 'h-9 w-9 rounded-full bg-white/10 text-white/70 font-semibold flex items-center justify-center';
    ...
    imageReplaceBtn.addEventListener('click', (e) => { e.stopPropagation(); imageInput.click(); });
    imageRemoveBtn.addEventListener('click', (e) => { e.stopPropagation(); clearImage(); });
    ...
    audioBrowseBtn.addEventListener('click', (e) => { e.stopPropagation(); audioInput.click(); });
    audioReplaceBtn.addEventListener('click', (e) => { e.stopPropagation(); audioInput.click(); });
    audioRemoveBtn.addEventListener('click', (e) => { e.stopPropagation(); clearAudio(); });
